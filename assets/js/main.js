...
var tableContent = {
    ...
    descriptions: [
        ...
        { 'Canvas/ JavaScript': "This project was originally supposed to challenge us to use JavaScript in our creation of a Web Application - I took it a small step further and decidd to research and learn how to use HTML Canvas in order to make the game more entertaining and impressive." },
